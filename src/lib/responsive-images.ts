 ...
 * Native art 1536×1024.
 */
export const heroResponsive: ResponsiveWidth[] = [
	{ src: '/images/squad-hacks-hero-640w.webp', width: 640 },
	{ src: '/images/squad-hacks-hero-1024w.webp', width: 1024 },
	{ src: '/images/squad-hacks-hero-1536w.webp', width: 1536 },
];

export const heroDesktopResponsive: ResponsiveWidth[] = heroResponsive;

/** Default LCP src — largest available WebP. */
export const heroSrc = '/images/squad-hacks-hero-1536w.webp';
