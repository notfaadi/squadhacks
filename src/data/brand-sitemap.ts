...
const defaultImages: BrandSitemapImage[] = [
	{
		...
		title: 'squad hacks esp',
		caption: 'squad hacks esp wallhack',
	},
	{
		src: '/images/squad-hacks-wallhack.webp',
		title: 'squad hacks wallhack',
		caption: 'squad hacks wallhack esp',
	},
	{
		src: '/images/squad-hacks-aimbot.webp',
		title: 'squad hacks aimbot',
		caption: 'squad hacks aimbot soft aim',
	},
	{
		src: '/images/squad-hacks-aimbot-view.webp',
		title: 'squad hacks aimbot',
		caption: 'squad hacks aimbot view',
	},
	{
		src: '/images/squad-hacks-radar.webp',
		title: 'squad hacks radar',
		caption: 'squad hacks radar hack',
	},
	{
		src: '/images/squad-hacks-raid.webp',
		title: 'squad hacks',
		caption: 'squad hacks in raid',
	},
];
...
const pageImageTemplates: Record<PageId, { title: string; caption: string }> = {
	home: { title: '{brand} hero — ESP and aimbot in Squad', caption: 'Homepage preview of {primaryKeyword} on Windows PC' },
	'squad-esp': { title: '{primaryKeyword} ESP overlay', caption: 'Player ESP boxes and distance with {primaryKeyword}' },
	'squad-aimbot': { title: '{primaryKeyword} aimbot view', caption: 'Aimbot and soft aim controls in {primaryKeyword}' },
	features: { title: '{primaryKeyword} features', caption: 'ESP, soft aim, radar, and Cloud DMA included with {primaryKeyword}' },
	...
	'cheats-2026': { title: '{primaryKeyword} overview', caption: '{primaryKeyword} for Squad on PC' },
