...
export const productInfo = {
	...
	features: {
		esp: [
			'Infantry and vehicle ESP / wallhack',
			'Player kit and threat cues',
			'HAB and rally markers',
			'Distance readouts',
			'Toggleable ESP categories',
			'Vehicle and HAB highlights',
		],
		aimbot: [
		...
		radar: ['2D radar overlay', 'Adjustable range', 'Works in infantry and vehicle matches'],
		general: [
			'Cloud DMA — no second PC required',
