...
const imageMap: Record<BlogImageKey, string> = {
	hero: squadImages.espWallhack,
	espWallhack: squadImages.espWallhack,
	aimbotCombat: squadImages.aimbotCombat,
	aimbotSkeleton: squadImages.aimbotSkeleton,
	squadFight: squadImages.aimbotCombat,
	headerArt: squadImages.playerEsp,
	cheatsPackage: squadImages.espWallhack,
	playerEsp: squadImages.playerEsp,
	rebootFight: squadImages.aimbotCombat,
	battleRoyaleCombat: squadImages.cheatsCombat,
	battleRoyaleIslandMap: squadImages.espWallhack,
};

const FALLBACK_BLOG_IMAGE = squadImages.espWallhack;
...
export function getBlogSitemapEntriesForLocale(locale: LocaleCode) {
	...
	for (const post of blogPosts) {
		...
		const isProductPost = /Squad Hacks|Aimbot|ESP|Undetected|Comparisons/i.test(post.category);
		entries.push({
