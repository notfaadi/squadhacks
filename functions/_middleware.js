...
const CANONICAL_ORIGIN = 'https://squadhacks.net';
const APEX_HOST = 'squadhacks.net';
const WWW_HOST = 'www.squadhacks.net';
...
const PATH_REDIRECTS = {
	...
	'/escape-from-squad-hacks': '/squad-hacks/',
	'/escape-from-squad-hacks/': '/squad-hacks/',
	// Cannibalization → canonical landings (money URL = /squad-hacks/)
	...
	'/best-squad-hacks/': '/squad-hacks/',
	'/squad-hacks-2026': '/squad-hacks/',
	'/squad-hacks-2026/': '/squad-hacks/',
	'/undetected-squad-hacks': '/squad-hacks/',
	'/undetected-squad-hacks/': '/squad-hacks/',
	'/squad-mod-menu': '/squad-hacks/',
	'/squad-mod-menu/': '/squad-hacks/',
	'/squad-unlock-all': '/squad-hacks/',
	'/squad-unlock-all/': '/squad-hacks/',
	'/squad-soft-aim': '/squad-aimbot/',
	'/squad-soft-aim/': '/squad-aimbot/',
	'/squad-wallhack': '/squad-esp/',
	'/squad-wallhack/': '/squad-esp/',
	'/squad-cheat-download': '/setup/',
	'/squad-cheat-download/': '/setup/',
	'/eac-bypass': '/updates/',
	'/eac-bypass/': '/updates/',
	'/warzone-cheats': '/squad-hacks/',
	'/warzone-cheats/': '/squad-hacks/',
	'/warzone-hacks': '/squad-hacks/',
	'/warzone-hacks/': '/squad-hacks/',
	'/warzone-esp': '/squad-esp/',
	'/warzone-esp/': '/squad-esp/',
	'/warzone-aimbot': '/squad-aimbot/',
	'/warzone-aimbot/': '/squad-aimbot/',
	'/ricochet-bypass': '/updates/',
	'/ricochet-bypass/': '/updates/',
	'/fortnite-aimbot': '/squad-aimbot/',
	'/fortnite-aimbot/': '/squad-aimbot/',
	'/fortnite-esp': '/squad-esp/',
	'/fortnite-esp/': '/squad-esp/',
	'/fortnite-hacks': '/squad-hacks/',
	'/fortnite-hacks/': '/squad-hacks/',
	'/eac-bypass': '/updates/',
	'/eac-bypass/': '/updates/',
	'/eac-bypass-fortnite': '/updates/',
	'/eac-bypass-fortnite/': '/updates/',
	'/blog/patch-notes-buffs-nerfs-vaults': '/blog/squad-patch-notes-guide/',
	'/blog/patch-notes-buffs-nerfs-vaults/': '/blog/squad-patch-notes-guide/',
	'/blog/chapter-7-season-3-skin-leaks-vbucks': '/blog/squad-skin-leaks-guide/',
	'/blog/chapter-7-season-3-skin-leaks-vbucks/': '/blog/squad-skin-leaks-guide/',
	'/blog/hammer-ar-s-tier-data-analysis': '/blog/squad-weapon-tier-list/',
	'/blog/hammer-ar-s-tier-data-analysis/': '/blog/squad-weapon-tier-list/',
	'/blog/zero-build-meta-broken-aggressive-strategies': '/blog/squad-scav-run-aggressive-strategies/',
	'/blog/zero-build-meta-broken-aggressive-strategies/': '/blog/squad-scav-run-aggressive-strategies/',
	'/blog/fncs-meta-watch-tournament-drops': '/blog/squad-tournament-meta-guide/',
	'/blog/fncs-meta-watch-tournament-drops/': '/blog/squad-tournament-meta-guide/',
	'/blog/secret-loot-routes-full-gold': '/blog/squad-loot-routes-guide/',
	'/blog/secret-loot-routes-full-gold/': '/blog/squad-loot-routes-guide/',
	'/blog/bugha-settings-pro-setup': '/blog/squad-pro-settings-guide/',
	'/blog/bugha-settings-pro-setup/': '/blog/squad-pro-settings-guide/',
	'/blog/creative-warmup-maps-pros-use': '/blog/squad-warmup-maps-ranked/',
	'/blog/creative-warmup-maps-pros-use/': '/blog/squad-warmup-maps-ranked/',
	'/reviews/squad-esp-zero-build-review-buildsr4k': '/reviews/squad-esp-scav-run-review-buildsr4k/',
	'/reviews/squad-esp-zero-build-review-buildsr4k/': '/reviews/squad-esp-scav-run-review-buildsr4k/',
	'/reviews/squad-radar-hack-review-vanlifefn': '/reviews/squad-radar-hack-review-vanlifeeft/',
	'/reviews/squad-radar-hack-review-vanlifefn/': '/reviews/squad-radar-hack-review-vanlifeeft/',
	'/reviews/squad-radar-hack-review-vanlifewz': '/reviews/squad-radar-hack-review-vanlifeeft/',
	'/reviews/squad-radar-hack-review-vanlifewz/': '/reviews/squad-radar-hack-review-vanlifeeft/',
	'/reviews/squad-controller-soft-aim-review-ctrl-player99': '/reviews/squad-soft-aim-review-ctrl-player99/',
	'/reviews/squad-controller-soft-aim-review-ctrl-player99/': '/reviews/squad-soft-aim-review-ctrl-player99/',
};
