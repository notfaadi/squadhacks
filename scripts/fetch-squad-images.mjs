...
import { buildOverlaySvg } from './squad-hack-overlays.mjs';

const imagesDir = path.resolve('public/images');
const publicDir = path.resolve('public');

/** Verified IGN Squad screenshot CDN paths. */
...
/**
 * Squad hacks image pipeline:
 * 1. Download real Squad gameplay from IGN
 * 2. Composite ESP / aimbot / radar / mod-menu overlays for squad hacks marketing
 */
const KEYWORD_ASSETS = [
	{
		file: 'squad-hacks-hero.webp',
		url: `${ME_G}/squad-screenshots_wjkx.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'squad-hacks-aimbot.webp',
		url: `${ME}/squad-screenshots_wjb1.1400.jpg`,
		overlay: 'aimbot',
	},
	{
		file: 'squad-hacks-esp-wallhack.webp',
		url: `${ME}/squad-screenshots_55fp.1400.jpg`,
		overlay: 'wallhack',
	},
	{
		file: 'squad-squad-fight.webp',
		url: `${ME}/squad-screenshots_67cp.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'squad-hacks-package.webp',
		url: `${ME}/squad-screenshots_anf4.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'squad-hacks-cover.webp',
		url: `${ME}/squad-screenshots_7pr8.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'squad-header-art.webp',
		url: `${ME}/squad-screenshots_c36j.1400.jpg`,
		overlay: 'hero',
	},
	{
		file: 'squad-loadout-builder.webp',
		url: `${NL}/squad-screenshots_e5gw.1400.jpg`,
		overlay: 'menu',
	},
	{
		file: 'squad-battle-royale-combat.webp',
		url: `${ME}/squad-screenshots_4h92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'squad-rally-fight.webp',
		url: `${BR}/goulag-inside_zusa.1400.png`,
		overlay: 'rally',
	},
	{
		file: 'squad-player-esp.webp',
		url: `${ME}/squad-screenshots_rb92.1400.jpg`,
		overlay: 'esp',
	},
	{
		file: 'squad-scav-run-combat.webp',
		url: `${BR}/plunder_px6d.1400.png`,
		overlay: 'scav-run',
	},
	{
		file: 'squad-scav-run-mode.webp',
		url: `${BR}/parachuting_qhh2.1400.png`,
		overlay: 'loot',
	},
	{
		file: 'squad-verdansk-map.webp',
...
async function cleanImagesDir() {
	...
	for (const file of files) {
		if (file.includes('squad-hacks-logo')) continue;
...
async function generateBrandAssets(heroBuffer) {
	...
	await writeFile(path.join(imagesDir, 'squad-hacks-logo.webp'), logoBuffer);
...
for (const asset of KEYWORD_ASSETS) {
	...
	try {
		...
		saved++;
		if (asset.file === 'squad-hacks-hero.webp') heroBuffer = webp;
	} catch (err) {
...
console.log(`\nDone — ${saved}/${KEYWORD_ASSETS.length} Squad hacks images (IGN base + ESP/aimbot overlays).`);
