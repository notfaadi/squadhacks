...
const ENGLISH_PATHS = [
	...
	'/terms/',
	'/blog/',
	'/blog/squad-scav-run-aggressive-strategies/',
	'/blog/squad-loot-routes-guide/',
	'/blog/squad-weapon-tier-list/',
	'/blog/squad-skin-leaks-guide/',
	'/blog/squad-tournament-meta-guide/',
	'/blog/squad-pro-settings-guide/',
	'/blog/squad-warmup-maps-ranked/',
	'/blog/squad-patch-notes-guide/',
	'/blog/squad-hacks-complete-guide-2026/',
	'/blog/escape-from-squad-hacks-buyers-guide/',
	'/blog/squad-hacks-2026-whats-new/',
	'/blog/squad-aimbot-settings-guide/',
	'/blog/squad-esp-wallhack-explained/',
	'/blog/undetected-squad-hacks-eac/',
	'/blog/squad-hacks-vs-cheatvault-comparison/',
	'/blog/elitefn-vs-squad-hacks-two-week-test/',
	'/blog/squad-hacks-vs-ghostware-features-pricing/',
	'/reviews/',
	'/reviews/squad-soft-aim-review-xkrypt0/',
	'/reviews/squad-esp-scav-run-review-buildsr4k/',
	'/reviews/squad-cloud-dma-review-dma-wizard/',
	'/reviews/squad-soft-aim-review-ctrl-player99/',
	'/reviews/squad-cheat-setup-review-stormchaser07/',
	'/reviews/squad-loot-esp-review-lootgoblinx/',
	'/reviews/squad-soft-aim-raid-review-rankedgrind42/',
	'/reviews/squad-radar-hack-review-vanlifeeft/',
	'/reviews/squad-eac-update-review-patchdaymike/',
	'/reviews/squad-sniper-soft-aim-review-snipezonly/',
	'/faq/what-are-squad-hacks/',
	'/faq/are-squad-hacks-undetected-in-2026/',
	...
	'/faq/what-is-a-squad-wallhack/',
	'/faq/does-squad-hacks-include-radar-hack/',
	'/faq/eac-anti-cheat-and-squad-hacks/',
	'/faq/buy-undetected-squad-hacks-windows-pc/',
];
...
function rallyLocs(xml) {
	return [...xml.matchAll(/<loc>([^<]+)<\/loc>/g)].map((m) => m[1]);
}

function rallyHreflangCount(xml, url) {
...
async function main() {
	...
	const indexLocs = rallyLocs(sitemapIndex);
	const enLocs = rallyLocs(sitemapEn);
	const i18nLocs = rallyLocs(sitemapI18n);
	const imageLocs = rallyLocs(sitemapImages);
	...
	const homeHreflang = rallyHreflangCount(sitemapEn, `${SITE}/`);
