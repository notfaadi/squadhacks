#!/usr/bin/env node
/**
 * Ports the 8 posts from ../squad-blog into src/data/blog/posts.generated.ts
...
const SOURCE_DIR = join(ROOT, '..', 'squad-blog', 'src', 'content', 'posts');
...
for (const file of POST_FILES) {
	...
	sources.push({
		...
		intro: post.excerpt,
		keywords: [...post.tags, 'squad intel'],
...
const file = `/* Auto-generated by scripts/port-from-squad-blog.mjs — do not edit by hand. */
