/**
 * SVG overlay generators for Squad hacks marketing images.
 * Composited on top of IGN Squad gameplay screenshots.
 */
...
export function buildOverlaySvg(width, height, preset) {
	...
	switch (preset) {
		...
		case 'loot':
			...
			body += espBox(width * 0.68, height * 0.52, width * 0.06, height * 0.08, 'rally timer · 103m', '#fbbf24');
